  ...
  return (
    ...
    <MaxWidthWrapper className="mt-20 mb-12 sm:mt-40 flex flex-col items-center justify-center text-center">
       ...
       <p className="mt-5 mb-5 max-w-pros text-zinc-700 sm:text-lg">
        ASKME allows you to have conversations with your PDF documents. All you need is to upload your file and start asking questions right away.
       </p>
       <Link className={buttonVariants({
        size: 'lg',
       },)} href={'/dashboard'} target="_blank"> Get Started <ArrowRight className="ml-1 h-5 w-5" /> </Link>
    </MaxWidthWrapper>

    <div>
      <div className="relative isolate">
        <div aria-hidden = 'true' className="pointer-events-none inset-x-0 absolute -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
          <div
          style={{
        ...
        <div>
          <div className="mx-auto mb-20 max-w-6xl px-6 lg:px-8">
            <div className="mt-16 flow-root sm:mt-24">
              ...
              <Image src='/dashboard-prev.jpg' alt="product-preview" width={1364} height={866} quality={100} />
              </div>
            </div>
          </div>
        </div>
